...
## 更新日志
### v2.1.0 (2025-6-17) 【重大更新 - 动态语言切换】
- 🚀 实现真正的动态语言切换，无需刷新浏览器，与官方体验一致
- 修复了"附加翻译"模式与 ComfyUI 官方原生翻译的兼容性问题
- 采用事件驱动架构和响应式设计，支持即时翻译状态切换
- 优化翻译优先级：附加翻译 > 官方原生翻译 > 英文原文
- 新增智能文本恢复系统，支持节点标题和标签的自动还原
- 重构核心翻译逻辑，移除强制重置，改为智能增量补充
